					...
					<div class="base_panel">
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								...
								<div class="x_panel">
									...
									<div class="input-prepend input-group">
										<span class="add-on input-group-addon"><i
											...
											type="text" name="reportrange_right" id="reportrange_right"
											class="form-control" />
									</div>
									<div>
									...
									<div class="x_panel">
										...
										<div class="checkbox">
											<label> <input type="checkbox" id="check_ddos_domain"
												checked="checked"> DDOS DOMAIN
											</label>
										</div>
										<div class="checkbox">
											<label> <input type="checkbox" id="check_ddos_client"
												checked="checked"> DDOS CLIENT
											</label>
										</div>
										<div class="checkbox">
											<label> <input type="checkbox" id="check_query_graph"
												checked="checked"> QUERY GRAPH
											</label>
										</div>
										<div class="checkbox">
										...
										<div class="panel">
											<label>
												<button type="button" class="btn btn-primary" id="makepdf">PDF
													생성</button>
											</label>
										</div>
									</div>
							...
							<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8"
								style="overflow-y: auto; min-width: 1050px; max-width: 1050px;">
								<div id="report_page">
									<!--  dns domain start -->
									<div id="dns_domain" class="row">
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
											<div class="x_panel" style="height: 475px;">
												<div class="x_title">
													<h2>
